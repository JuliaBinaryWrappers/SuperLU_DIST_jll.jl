# Autogenerated wrapper script for SuperLU_DIST_jll for armv6l-linux-musleabihf
...
function __init__()
    JLLWrappers.@generate_init_header(OpenBLAS32_jll, PARMETIS_jll, MPICH_jll, METIS_jll, CompilerSupportLibraries_jll)
