# Autogenerated wrapper script for SuperLU_DIST_jll for x86_64-unknown-freebsd
...
function __init__()
    JLLWrappers.@generate_init_header(OpenBLAS32_jll, PARMETIS_jll, MPICH_jll, METIS_jll, LLVMOpenMP_jll)
